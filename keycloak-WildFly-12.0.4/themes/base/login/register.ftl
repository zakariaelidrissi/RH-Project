<#import "template.ftl" as layout>
    <@layout.registrationLayout
        displayMessage=!messagesPerField.existsError('firstName','cin','dateNaissance','telephone','gender','lastName','email','password','password-confirm');
        section>
        <#if section="header">
            ${msg("registerTitle")}
            <#elseif section="form">
                <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="${properties.kcInputWrapperClass!}">
                            <input type="date" class="${properties.kcInputClass!}" id="user.attributes.dob"
                                name="user.attributes.dob" value="${(register.formData['user.attributes.dob']!'')}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="${properties.kcLabelWrapperClass!}">
                            <label for="user.attributes.cin" class="${properties.kcLabelClass!}">
                                CIN</label>
                        </div>

                        <div class="${properties.kcInputWrapperClass!}">
                            <input type="text" class="${properties.kcInputClass!}" id="user.attributes.cin"
                                name="user.attributes.cin" value="${(register.formData['user.attributes.cin']!'')}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="${properties.kcLabelWrapperClass!}">
                        ...
                        <div class="${properties.kcInputWrapperClass!}">
                            <select type="text" class="${properties.kcInputClass!}" id="user.attributes.gender"
                    ...
                    <div class="form-group">
                        <div class="${properties.kcLabelWrapperClass!}">
                            <label for="user.attributes.telephone" class="${properties.kcLabelClass!}">
                                Telephone</label>
                        </div>

                        <div class="${properties.kcInputWrapperClass!}">
                            <input type="text" class="${properties.kcInputClass!}" id="user.attributes.telephone"
                                name="user.attributes.telephone"
                                value="${(register.formData['user.attributes.telephone']!'')}">
                            />
                        </div>
                    </div>
                    <!--Added-->
